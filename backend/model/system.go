...
func (u SystemModel) GetWorkfreelance(Type_Work_ID dateset.Typeworkid ) ([]dateset.Getworkpagehomefreelance,error)  {
...
func (u SystemModel) GetWorkcompany(Type_Work_ID dateset.Typeworkid ) ([]dateset.Getworkpagehomecompany,error)  {
